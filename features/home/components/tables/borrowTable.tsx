...
export default function BorrowTable({ borrowAssets }: { borrowAssets: BorrowAssets[] }) {
            ...
            {borrowAssets.length === 0 ? (
              <tr>
                <td colSpan={3} className="p-4 text-center">
                  <div className="text-[#E0E0E0]/70">No Borrow Assets</div>
                </td>
              </tr>
            ) : (
