      ...
      <div className="flex flex-col rounded-md overflow-hidden">
        ...
        <div className="flex flex-col items-center justify-center p-6 gap-4">
          ...
          <div className="flex flex-col items-center gap-1.5">
            <span className="text-[#FFFFFF] font-medium text-sm leading-[20px]">Ready to Earn?</span>
            <span className="text-[#666666] text-xs text-center leading-[19.5px] max-w-[167px]">Your idle assets could be growing.</span>
          </div>
          <button 
            onClick={onAddAssets}
