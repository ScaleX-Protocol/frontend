...
import { Bot, ExternalLink, Code, FileText, Copy, Check } from "lucide-react";
...
export default function RegisterAgentModal({
  ...
  const handleCopy = async (text: string, type: "repo" | "skill") => {
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="space-y-3">
          <p className="text-[#A0A0A0] text-sm leading-relaxed">
            Want to build and register your own AI trading agent on ScaleX? We
            provide everything you need to get started.
          </p>
        </div>

        {/* Option 1: Example Repository */}
        <div className="bg-[#111111] border border-[#1F1F1F] rounded-xl p-4 space-y-3">
          ...
          <p className="text-[#808080] text-sm">
            Clone our reference implementation to see a fully working agent with
            MCP tools, A2A protocol support, and trading capabilities.
          </p>
          <div className="flex items-center gap-2">
            <a
              href={exampleRepoUrl}
        ...
        <div className="bg-[#111111] border border-[#1F1F1F] rounded-xl p-4 space-y-3">
          ...
          <p className="text-[#808080] text-sm">
            Prefer to code from scratch? Our SKILL.md documentation provides all
            the context, MCP tools, and API references you need.
          </p>
          <div className="flex items-center gap-2">
            <a
              href={skillsDocUrl}
