      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-6 right-6 z-50 w-[520px] max-w-[calc(100vw-48px)] h-[780px] max-h-[calc(100vh-124px)] bg-[#0C0C0C] border border-[#1F1F1F] rounded-2xl shadow-2xl flex flex-col overflow-hidden"
          >
            {/* Header */}
