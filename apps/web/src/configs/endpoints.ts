...
export const Endpoints: EndpointConfig = {
  api: isLocalBackend ? 'http://localhost:3000' : (import.meta.env.VITE_API_URL || 'https://base-sepolia-api.scalex.money'),
  indexer: isLocalBackend ? 'http://localhost:42069' : (import.meta.env.VITE_INDEXER_API_URL || 'https://base-sepolia-api.scalex.money'),
