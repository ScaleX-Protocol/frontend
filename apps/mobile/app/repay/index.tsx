...
import { usePrivyRepay } from '~/src/hooks/lending/usePrivyRepay';
import type { LendingTokenSymbol } from '~/src/lib/solana/lending';

const REPAY_TOKENS: LendingTokenSymbol[] = ['USDT', 'BTC', 'WETH'];
...
export default function RepayScreen() {
  ...
  const [selectedToken, setSelectedToken] =
    React.useState<LendingTokenSymbol>('USDT');
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Repay</Text>
      </View>
        ...
        >
          ...
          <View style={styles.infoBox}>
            <Text style={styles.infoText}>
              Repay {selectedToken} to reduce your borrow position. Use tokens from your wallet.
            </Text>
          </View>
          ...
          {hash && (
            <View style={styles.successBox}>
              <Text style={styles.successText}>Repay confirmed!</Text>
          ...
          <TouchableOpacity
            style={[
              styles.actionButton,
              (!canRepay || isPending) && styles.actionButtonDisabled,
            ]}
            onPress={handleRepay}
            ...
            {isPending ? (
              ...
              <Text
                style={[
                  ...
                  (!canRepay || isPending) && styles.actionButtonTextDisabled,
                ]}
              >
                Repay {selectedToken}
              </Text>
          ...
          {!isAuthenticated && (
            <Text style={styles.connectHint}>
              Connect your Solana wallet to repay
            </Text>
          )}
        </ScrollView>
      </KeyboardAvoidingView>
...
const styles = StyleSheet.create({
  ...
  maxButtonText: { fontSize: 14, fontWeight: '600', color: '#FFF' },
  infoBox: {
    backgroundColor: '#1A1A1A',
    borderRadius: 12,
    padding: 16,
